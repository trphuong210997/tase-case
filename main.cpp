...
#define folder_input "TestCase_1/TestCase_1/input/input"
#define folder_output "TestCase_1/TestCase_1/output/output"
#define folder_expect "TestCase_1/TestCase_1/expect/expect"
...
int main(int argc, char *argv[])
{
    ...
    if (argc == 1)
    {
        ...
        for (int i = START; i <= END; i++)
        {
            ...
            if(i <= 300) run_task_1(to_string(i));
            else if(i <=500) run_task_2(to_string(i));
            else   run_task_3(to_string(i));
